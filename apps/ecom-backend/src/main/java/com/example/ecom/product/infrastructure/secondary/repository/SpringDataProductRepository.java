...
public class SpringDataProductRepository implements ProductRepository {
  ...
  private final JpaProductPicture jpaProductPicture;

  public SpringDataProductRepository(JpaCategoryRepository jpaCategoryRepository, JpaProductRepository jpaProductRepository, JpaProductPicture jpaProductPicture) {
    this.jpaCategoryRepository = jpaCategoryRepository;
    this.jpaProductRepository = jpaProductRepository;
    this.jpaProductPicture = jpaProductPicture;
  }
  ...
  private void saveAllPictures(List<Picture> pictures, ProductEntity newProductEntity) {
    ...
    jpaProductPicture.saveAll(picturesEntities);
  }
